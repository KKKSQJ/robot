...
if __name__ == '__main__':
    ...
    parser.add_argument('--datacfg', type=str, default='cfg/sugar.data') # data config
    parser.add_argument('--modelcfg', type=str, default='cfg/yolo-pose.cfg') # network config
    parser.add_argument('--weightfile', type=str, default='backup/sugar/model.weights') # imagenet initialized weights
